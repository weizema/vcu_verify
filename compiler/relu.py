'''
Author: weizema
Date: 2023-07-31 19:13:48
LastEditors: weizema
LastEditTime: 2023-07-31 20:36:08
Description: 
'''
...
vcu_compiler.get_vcu_config_insn(
    ...
    multiplication_constant_0=int(half2bin_tensor(1.0),2),
    multiplication_constant_1=int(half2bin_tensor(1.0),2),
