 ...
 * @LastEditors: weizema
 * @LastEditTime: 2023-08-02 20:58:05
 * @Description:
 */
#pragma once
...
enum VCU_EXECUTE {
  ...
  VCU_INSN_COMPUTE_LENGTH_BITS_1      = 5,
  VCU_INSN_COMPUTE_LENGTH_BITS_0      = 7,
  ...
  VCU_INSN_PARA_CHANNEL_STRIDE_BITS           = 9,
  VCU_INSN_PARA_FUNCTIONAL_STRIDE_BITS=4;
  VCU_INSN_FREE_BITS =
    (128 - OPCODE_BITS - VCU_INSNTYPE_BITS - VCU_INSN_DATA_RAM_IN_ADDRESS_BITS - VCU_INSN_DATA_RAM_OUT_ADDRESS_BITS
     - VCU_INSN_PARA_RAM_IN_ADDRESS_BITS - VCU_INSN_RESADD_RAM_IN_ADDRESS_BITS - VCU_INSN_FPU_BITS
     - VCU_INSN_COMPUTE_LENGTH_BITS_1 - VCU_INSN_COMPUTE_LENGTH_BITS_0 - VCU_INSN_RAM_OUT_MODE_BITS
     - VCU_INSN_RAM_DATA_IN_TYPE_BITS - VCU_INSN_RAM_DATA_OUT_TYPE_BITS - VCU_INSN_PARA_RAM_VALID_BITS
     - VCU_INSN_MULT_PARA_BITS - VCU_INSN_RESADD_RAM_VALID_BITS - VCU_INSN_RESADD_PARA_TYPE_BITS
     - VCU_INSN_FPU_WORK_BITS - VCU_INSN_PARA_STRIDE_BITS)
};
...
enum VCU_CONFIG {
  ...
  VCU_CONFIG_MULTIPLICATION_CONSTANT_0_BITS_0 = 12,
  VCU_CONFIG_MULTIPLICATION_CONSTANT_0_BITS_1 = 4,
  ...
  VCU_CONFIG_FREE_BITS =
    (128 - OPCODE_BITS - VCU_INSNTYPE_BITS - VCU_CONFIG_ADDER_CONSTANT_0_BITS - VCU_CONFIG_ADDER_CONSTANT_1_BITS
     - VCU_CONFIG_ADDER_CONSTANT_2_BITS - VCU_CONFIG_MULTIPLICATION_CONSTANT_0_BITS_0
     - VCU_CONFIG_MULTIPLICATION_CONSTANT_0_BITS_1 - VCU_CONFIG_MULTIPLICATION_CONSTANT_1_BITS
...
typedef struct {
  ...
  uint64_t VCU_INSN_COMPUTE_LENGTH_0 : VCU_INSN_COMPUTE_LENGTH_BITS_0;
  uint64_t VCU_INSN_COMPUTE_LENGTH_1 : VCU_INSN_COMPUTE_LENGTH_BITS_1;
...
typedef struct {
  ...
  uint64_t VCU_CONFIG_MULTIPLICATION_CONSTANT_0_0 : VCU_CONFIG_MULTIPLICATION_CONSTANT_0_BITS_0;
  uint64_t VCU_CONFIG_MULTIPLICATION_CONSTANT_0_1 : VCU_CONFIG_MULTIPLICATION_CONSTANT_0_BITS_1;
